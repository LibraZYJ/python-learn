...
def str_high_frequency():
    ...
    print(pat.fullmatch('asd12'))   # 返回 None，长度小于 6
    print(pat.fullmatch('asdfswsxedc43434'))    # None 长度大于 12
    print(pat.fullmatch('asd_231'))  # None 含有下划线
    print(pat.fullmatch('asdfasdf'))  # 符合
